...
books["large_thumbnail"] = books["thumbnail"] + "&fife=w800" ## added this to the existing thumbmail url to get larger images
...
with gr.Blocks(theme = gr.themes.Default()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label= "Please enter a description of a book:",
                                placeholder = "e.g, A story in middle ages era")
